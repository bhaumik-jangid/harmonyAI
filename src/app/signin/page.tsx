...
export default function AuthForm() {
  ...
  return (
    <div className="flex flex-col justify-center items-center min-h-screen bg-gray-900 px-4 sm:px-6 md:px-8">
      <Toaster />
      <h1 className="text-white text-2xl font-bold mb-6 cursor-pointer" onClick={() => router.push("/")}>HarmonyAI</h1>
      <div className="w-full max-w-md p-6 bg-gray-800 rounded-2xl shadow-xl">
        <motion.div initial={{ height: "auto" }} animate={{ height: "auto" }} className="overflow-hidden">
          ...
          <p className="text-gray-400 text-center mt-4">
            ...
            <button onClick={() => setIsSignup(!isSignup)} className="text-green-400 hover:underline ml-1">
