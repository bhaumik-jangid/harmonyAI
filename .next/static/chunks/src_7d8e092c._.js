(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["static/chunks/src_7d8e092c._.js", {
...
const ChatPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "ChatPage.useEffect": ()=>{
            ...
            const fetchChatHistory = {
                "ChatPage.useEffect.fetchChatHistory": async ()=>{
                    try {
            ...
            }["ChatPage.useEffect.fetchChatHistory"];
            fetchChatHistory();
        }
    }["ChatPage.useEffect"], [
        sessionId,
    ...
    const handleSendMessage = async ()=>{
        ...
        if (inputText.trim() && userId) {
            ...
            try {
                const response = await fetch(`https://medgurubackend.onrender.com/api/chat/${userId}/${sessionId || "new"}`, {
                    method: "POST",
                    headers: {
...
_s(ChatPage, "g99CNL2lcRXY44TLjwm9Bn6upzA=", false, function() {
    return [
...
//# sourceMappingURL=src_7d8e092c._.js.map